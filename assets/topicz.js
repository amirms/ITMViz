...
function update_drawing()
{
    ...
    if (old_winning_state.element !== undefined) {
        ...
        case "topic":
            ...
            break;
		case "topicname":
            topic_name_off.call(old_winning_state.element, old_winning_state.object);
            break;	
        }
    ...
    case "topic":
        ...
        break;
	case "topicname":
		topic_name_on.call(winning_state.element, winning_state.object);
    }
...
$.extend(scatterOutputBinding, {
	...
	points.append("circle")
			...
			.on("dblclick", function(d) {
					...
					current_doc_hover.what = "topicname";
